...
export function registerAllWidgets() {
  ...
  registerWidget('goals-map', {
    ...
    category: 'dashboard',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Dashboard/components/GoalsMap.vue')),
  ...
  registerWidget('agents-swarm', {
    ...
    icon: 'fas fa-robot',
    category: 'dashboard',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Dashboard/components/AgentsSwarm.vue')),
    defaultSize: { cols: 4, rows: 4 },
    minSize: { cols: 2, rows: 2 },
  ...
  registerWidget('runs-queue', {
    ...
    category: 'dashboard',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Dashboard/components/RunsQueue.vue')),
    defaultSize: { cols: 4, rows: 4 },
    minSize: { cols: 2, rows: 2 },
  ...
  registerWidget('chat', {
    ...
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Chat/Chat.vue')),
  ...
  registerWidget('workspace-chat', {
    ...
    icon: 'fas fa-comments',
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Workspace/WorkspaceChatWidget.vue')),
  ...
  registerWidget('dashboard', {
    ...
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Dashboard/Dashboard.vue')),
    defaultSize: { cols: 12, rows: 8 },
  ...
  registerWidget('tools', {
    ...
    icon: 'fas fa-wrench',
    category: 'assets',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Tools/Tools.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('workflows', {
    ...
    category: 'assets',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Workflows/Workflows.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('goals', {
    ...
    icon: 'fas fa-bullseye',
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Goals/Goals.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('artifacts', {
    ...
    icon: 'fas fa-cube',
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Artifacts/Artifacts.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('memory', {
    ...
    icon: 'fas fa-brain',
    category: 'home',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Memory/Memory.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('settings', {
    ...
    icon: 'fas fa-cog',
    category: 'system',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Settings/Settings.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 6, rows: 4 },
  ...
  registerWidget('connectors', {
    ...
    icon: 'fas fa-key',
    category: 'system',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Connectors/Connectors.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('marketplace', {
    ...
    icon: 'fas fa-store',
    category: 'system',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/Marketplace/Marketplace.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 4, rows: 3 },
  ...
  registerWidget('workflow-forge', {
    ...
    icon: 'fas fa-hammer',
    category: 'forge',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/WorkflowForge/WorkflowForge.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 6, rows: 4 },
  ...
  registerWidget('tool-forge', {
    ...
    icon: 'fas fa-tools',
    category: 'forge',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/ToolForge/ToolForge.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 6, rows: 4 },
  ...
  registerWidget('widget-manager', {
    ...
    category: 'forge',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/WidgetManager/WidgetManager.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 6, rows: 4 },
  ...
  registerWidget('widget-forge', {
    ...
    icon: 'fas fa-magic',
    category: 'forge',
    component: lazyComponent(() => import('@/views/Terminal/CenterPanel/screens/WidgetForge/WidgetForge.vue')),
    defaultSize: { cols: 12, rows: 8 },
    minSize: { cols: 6, rows: 4 },
