    ...
    async onImportOutputClick() {
      ...
      if (outputId) {
        try {
          ...
          const response = await axios.get(`${baseUrl}/content-outputs/${outputId}`);
          ...
          // Save as new content to local database
          ...
          this.showAlert('Output imported and saved as a new copy successfully!');
        } catch (error) {
