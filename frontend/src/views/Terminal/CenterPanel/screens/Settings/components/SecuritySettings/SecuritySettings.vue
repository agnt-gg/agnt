...
<style scoped>
.security-console{display:flex;flex-direction:column;gap:24px;color:var(--color-text)}
.policy-hero{border-radius:12px;display:flex;justify-content:space-between;align-items:center;gap:24px;padding:24px 32px;border:1px solid var(--terminal-border-color-light);background:linear-gradient(135deg,color-mix(in srgb,var(--color-primary) 8%,var(--terminal-section-bg)),var(--terminal-section-bg));position:relative;overflow:hidden}.eyebrow,.section-kicker{font:700 10px var(--font-family-monospace);letter-spacing:.14em;color:var(--color-primary)}.eyebrow i{margin-right:8px}.hero-copy h3,.section-header h3{font-size:20px;margin:6px 0 4px}.hero-copy p,.section-header p{margin:0;color:var(--color-text-muted);font-size:13px}.hero-status{display:flex;align-items:center;gap:12px;padding:12px 16px;border:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 72%,transparent);z-index:1}.hero-status>div{display:flex;flex-direction:column}.hero-status small{font:700 9px var(--font-family-monospace);color:var(--color-text-muted);letter-spacing:.12em}.hero-status strong{font-size:14px}.status-dot{width:9px;height:9px;border-radius:50%;background:var(--color-green);box-shadow:0 0 12px var(--color-green)}
.mode-grid{display:flex;justify-content:space-between;align-items:stretch;gap:8px;width:100%}.mode-grid :deep(.tooltip-container){height:100%;flex:1 1 0;min-width:0}.mode-card{border-radius:12px;width:100%;height:100%;min-height:88px;display:flex;align-items:center;gap:12px;padding:16px;border:1px solid var(--terminal-border-color-light);background:var(--terminal-section-bg);color:var(--color-text);cursor:pointer;text-align:left;transition:.16s;position:relative}.mode-card:hover{border-color:color-mix(in srgb,var(--color-primary) 60%,var(--terminal-border-color-light));transform:translateY(-2px)}.mode-card.active{border-color:var(--color-primary);box-shadow:inset 0 0 0 1px var(--color-primary),0 8px 24px color-mix(in srgb,var(--color-primary) 10%,transparent)}.mode-icon{display:grid;place-items:center;width:34px;height:34px;background:color-mix(in srgb,var(--color-primary) 10%,transparent);color:var(--color-primary)}.mode-copy{display:flex;flex-direction:column;gap:3px;min-width:0}.mode-copy strong{font-size:13px}.mode-copy small{font-size:10px;color:var(--color-text-muted)}.selected-mark{position:absolute;right:10px;top:10px;color:var(--color-primary);font-size:11px}
.management-panel{border-radius:12px;border:1px solid var(--terminal-border-color-light);background:var(--terminal-section-bg);padding:24px}.section-header{display:flex;justify-content:space-between;align-items:flex-end;gap:24px;margin-bottom:20px}.section-header.compact{align-items:flex-start;margin-bottom:16px}.legend{display:flex;align-items:center;gap:8px;font:600 9px var(--font-family-monospace);text-transform:uppercase;color:var(--color-text-muted);white-space:nowrap}.legend-line{width:72px;height:3px;background:linear-gradient(90deg,var(--color-green),var(--color-yellow),var(--color-red));border-radius:3px}
.category-stack{display:flex;flex-direction:column;gap:8px}.category-card{border-radius:12px;border:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 35%,transparent);transition:.16s}.category-card.open{border-color:color-mix(in srgb,var(--color-primary) 45%,var(--terminal-border-color-light));box-shadow:0 12px 32px rgba(0,0,0,.12)}.category-summary{display:grid;grid-template-columns:minmax(280px,1fr) minmax(260px,360px) 130px;align-items:center;gap:24px;padding:16px}.category-identity{display:flex;align-items:center;gap:14px;border:0;background:transparent;color:inherit;text-align:left;cursor:pointer;min-width:0}.category-icon{display:grid;place-items:center;flex:0 0 40px;height:40px;border:1px solid var(--terminal-border-color-light);color:var(--color-primary);background:var(--terminal-section-bg)}.category-copy{display:flex;flex-direction:column;gap:5px;min-width:0}.category-title-row{display:flex;align-items:center;gap:8px}.category-title-row strong{font-size:14px}.category-copy small{color:var(--color-text-muted);font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.exception-badge{padding:3px 7px;border:1px solid color-mix(in srgb,var(--color-yellow) 45%,transparent);color:var(--color-yellow);font:700 9px var(--font-family-monospace);text-transform:uppercase}.category-policy{display:flex;flex-direction:column;gap:5px}.control-label{font:700 9px var(--font-family-monospace);color:var(--color-text-muted);text-transform:uppercase;letter-spacing:.08em}.expand-button{display:flex;align-items:center;justify-content:space-between;gap:8px;border:1px solid var(--terminal-border-color-light);background:transparent;color:var(--color-text);padding:9px 12px;font-size:11px;cursor:pointer}.expand-button:hover{border-color:var(--color-primary);color:var(--color-primary)}
.rule-panel{border-top:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 58%,transparent);padding:16px 24px 24px}.rule-toolbar{display:flex;justify-content:space-between;align-items:center;padding:0 0 12px;border-bottom:1px solid var(--terminal-border-color-light)}.rule-toolbar>div{display:flex;gap:8px;align-items:baseline}.rule-toolbar strong{font-size:12px}.rule-toolbar span{font-size:11px;color:var(--color-text-muted)}.text-button{border:0;background:transparent;color:var(--color-primary);font-size:11px;cursor:pointer}.rule-list{display:flex;flex-direction:column}.rule-row{display:grid;grid-template-columns:minmax(280px,1fr) minmax(260px,360px);align-items:center;gap:32px;padding:14px 0;border-bottom:1px solid color-mix(in srgb,var(--terminal-border-color-light) 65%,transparent)}.rule-row:last-child{border-bottom:0}.rule-copy{display:flex;flex-direction:column;gap:4px;min-width:0}.rule-name-line{display:flex;align-items:center;gap:8px}.rule-name-line strong{font-size:12px}.rule-copy>small{font:500 9px var(--font-family-monospace);color:var(--color-text-muted)}.severity{padding:2px 6px;font:700 8px var(--font-family-monospace);text-transform:uppercase;border:1px solid}.severity.critical{color:var(--color-red);border-color:color-mix(in srgb,var(--color-red) 45%,transparent)}.severity.high{color:var(--color-orange);border-color:color-mix(in srgb,var(--color-orange) 45%,transparent)}.severity.medium{color:var(--color-yellow);border-color:color-mix(in srgb,var(--color-yellow) 45%,transparent)}.severity.low{color:var(--color-green);border-color:color-mix(in srgb,var(--color-green) 45%,transparent)}.info-icon{color:var(--color-text-muted);font-size:11px;cursor:help;opacity:.75}.info-icon:hover{opacity:1}
.lower-grid{display:grid;grid-template-columns:1fr;gap:16px}.section-explainer{display:flex;align-items:flex-start;gap:12px;padding:14px 16px;border:1px solid color-mix(in srgb,var(--color-primary) 28%,var(--terminal-border-color-light));background:color-mix(in srgb,var(--color-primary) 5%,var(--terminal-bg));margin:16px 0}.section-explainer>i{color:var(--color-primary);margin-top:2px}.section-explainer>div{display:flex;flex-direction:column;gap:5px}.section-explainer strong{font-size:11px}.section-explainer p{margin:0;color:var(--color-text-muted);font-size:10px;line-height:1.55}.section-explainer em{color:var(--color-text);font-style:normal;font-weight:700}.section-explainer b{color:var(--color-text);font-weight:700}.output-choice-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin:20px 0 18px}.output-choice{border-radius:12px;position:relative;display:flex;flex-direction:column;align-items:flex-start;gap:10px;min-height:150px;padding:16px;border:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 40%,transparent);color:var(--color-text);text-align:left;cursor:pointer;transition:.16s}.output-choice:hover{transform:translateY(-2px);border-color:var(--color-primary)}.output-choice.active.off{border-color:var(--color-red);box-shadow:inset 0 0 0 1px var(--color-red)}.output-choice.active.report{border-color:var(--color-yellow);box-shadow:inset 0 0 0 1px var(--color-yellow)}.output-choice.active.enforce{border-color:var(--color-green);box-shadow:inset 0 0 0 1px var(--color-green)}.output-choice-icon{display:grid;place-items:center;width:32px;height:32px;border:1px solid var(--terminal-border-color-light)}.output-choice.off .output-choice-icon{color:var(--color-red)}.output-choice.report .output-choice-icon{color:var(--color-yellow)}.output-choice.enforce .output-choice-icon{color:var(--color-green)}.output-choice-copy{display:flex;flex-direction:column;gap:6px}.output-choice-copy strong{font-size:12px}.output-choice-copy small{font-size:10px;line-height:1.5;color:var(--color-text-muted)}.output-choice-check{position:absolute;top:12px;right:12px}.output-choice.active.off .output-choice-check{color:var(--color-red)}.output-choice.active.report .output-choice-check{color:var(--color-yellow)}.output-choice.active.enforce .output-choice-check{color:var(--color-green)}.output-scale-label{display:flex;justify-content:space-between;margin:0 4px 8px;color:var(--color-text-muted);font:600 9px var(--font-family-monospace);text-transform:uppercase}.output-scale-label span:first-child i{color:var(--color-red)}.output-scale-label span:last-child i{color:var(--color-green)}.output-panel :deep(.level-control){max-width:none;margin:0 0 18px}.active-output-summary{border-radius:12px;display:flex;align-items:center;gap:12px;padding:12px 14px;border:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 52%,transparent)}.active-output-summary>i{color:var(--color-primary);font-size:18px}.active-output-summary>div{display:flex;flex-direction:column;gap:3px}.active-output-summary small{font:700 8px var(--font-family-monospace);letter-spacing:.1em;color:var(--color-text-muted)}.active-output-summary strong{font-size:11px;line-height:1.45}.policy-footer{border-radius:0;position:sticky;bottom:0;display:flex;justify-content:space-between;align-items:center;gap:16px;padding:16px 24px;border:1px solid var(--terminal-border-color-light);background:color-mix(in srgb,var(--terminal-bg) 92%,transparent);backdrop-filter:blur(14px);z-index:4}.dirty-state{display:flex;align-items:center;gap:8px;font-size:11px;color:var(--color-text-muted)}.dirty-state>span{width:7px;height:7px;border-radius:50%;background:var(--color-green)}.dirty-state>span.changed{background:var(--color-yellow);box-shadow:0 0 10px var(--color-yellow)}.footer-actions{display:flex;gap:8px}.primary-button,.secondary-button{display:flex;align-items:center;gap:8px;padding:10px 16px;border:1px solid var(--color-primary);font-size:11px;font-weight:700;cursor:pointer}.primary-button{background:var(--color-primary);color:var(--terminal-bg)}.secondary-button{background:transparent;color:var(--color-primary)}.primary-button:disabled,.secondary-button:disabled{opacity:.45;cursor:not-allowed}.notice{border-radius:12px;display:flex;align-items:center;gap:8px;padding:12px 16px;border-left:3px solid;font-size:12px}.notice.error{border-color:var(--color-red);background:color-mix(in srgb,var(--color-red) 8%,transparent)}.notice.success{border-color:var(--color-green);background:color-mix(in srgb,var(--color-green) 8%,transparent)}
