<template>
  <section class="recovery-panel" aria-label="Goal recovery" @click.stop>
    <div class="recovery-heading">
      ...
      <button type="button" class="recovery-refresh" data-test="refresh" aria-label="Refresh recovery status" title="Refresh recovery status" :disabled="loading || saving" @click="load">
