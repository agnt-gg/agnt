...
const PROVIDER_CONFIGS = [
  ...
  // ─────────────────────────── KIMI ───────────────────────────
  {
    ...
    fallbackModels: ['kimi-k2.5', 'kimi-k2-thinking', 'kimi-k2-thinking-turbo', 'kimi-k2-0905', 'kimi-k2', 'moonshot-v1-128k', 'moonshot-v1-32k'],
    fallbackVisionModels: ['kimi-k2.5'],
    modelMetadata: {
      'kimi-k2.5': { contextWindow: 262144, maxOutputTokens: 16384, inputCostPer1M: 1.0, outputCostPer1M: 4.0, supportsVision: true, supportsTools: true, reasoning: false },
      'kimi-k2-thinking': { contextWindow: 262144, maxOutputTokens: 16384, inputCostPer1M: 1.0, outputCostPer1M: 4.0, supportsVision: false, supportsTools: true, reasoning: true },
      'kimi-k2-thinking-turbo': { contextWindow: 262144, maxOutputTokens: 16384, inputCostPer1M: 0.5, outputCostPer1M: 2.0, supportsVision: false, supportsTools: true, reasoning: true },
      'kimi-k2-0905': { contextWindow: 262144, maxOutputTokens: 16384, inputCostPer1M: 0.8, outputCostPer1M: 3.0, supportsVision: false, supportsTools: true, reasoning: false },
      'kimi-k2': { contextWindow: 131072, maxOutputTokens: 16384, inputCostPer1M: 0.5, outputCostPer1M: 2.0, supportsVision: false, supportsTools: true, reasoning: false },
  ...
  // ─────────────────────────── MINIMAX ───────────────────────────
  {
    ...
    fallbackModels: ['MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'],
    modelMetadata: {
      'MiniMax-M2.5': { contextWindow: 204800, maxOutputTokens: 16384, inputCostPer1M: 0.4, outputCostPer1M: 1.6, supportsVision: false, supportsTools: true, reasoning: false },
      'MiniMax-M2.5-highspeed': { contextWindow: 204800, maxOutputTokens: 16384, inputCostPer1M: 0.2, outputCostPer1M: 0.8, supportsVision: false, supportsTools: true, reasoning: false },
      'MiniMax-M2.1': { contextWindow: 204800, maxOutputTokens: 16384, inputCostPer1M: 0.3, outputCostPer1M: 1.2, supportsVision: false, supportsTools: true, reasoning: false },
      'MiniMax-M2.1-highspeed': { contextWindow: 204800, maxOutputTokens: 16384, inputCostPer1M: 0.15, outputCostPer1M: 0.6, supportsVision: false, supportsTools: true, reasoning: false },
      'MiniMax-M2': { contextWindow: 204800, maxOutputTokens: 16384, inputCostPer1M: 0.3, outputCostPer1M: 1.2, supportsVision: false, supportsTools: true, reasoning: false },
    },
    compat: {},
    sdkOptions: {},
  },
  ...
  // ─────────────────────────── ZAI ───────────────────────────
  {
    ...
    fallbackModels: ['GLM-5', 'GLM-4.7', 'GLM-4.7-Flash', 'GLM-4.7-FlashX', 'GLM-4.6V', 'GLM-4.5-Air', 'GLM-4.5-Flash'],
    fallbackVisionModels: ['GLM-4.6V', 'GLM-4.6V-Flash'],
    modelMetadata: {
      'GLM-5': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 1.0, outputCostPer1M: 3.2, supportsVision: false, supportsTools: true, reasoning: true },
      'GLM-4.7': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0.5, outputCostPer1M: 1.5, supportsVision: false, supportsTools: true, reasoning: false },
      'GLM-4.7-Flash': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0, outputCostPer1M: 0, supportsVision: false, supportsTools: true, reasoning: false },
      'GLM-4.7-FlashX': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0.07, outputCostPer1M: 0.4, supportsVision: false, supportsTools: true, reasoning: false },
      'GLM-4.6V': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0.3, outputCostPer1M: 0.9, supportsVision: true, supportsTools: true, reasoning: false },
      'GLM-4.5-Air': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0.2, outputCostPer1M: 1.1, supportsVision: false, supportsTools: true, reasoning: false },
      'GLM-4.5-Flash': { contextWindow: 128000, maxOutputTokens: 16384, inputCostPer1M: 0, outputCostPer1M: 0, supportsVision: false, supportsTools: true, reasoning: false },
    },
    compat: {},
    sdkOptions: {},
  },
