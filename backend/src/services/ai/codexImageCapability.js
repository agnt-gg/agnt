import { CODEX_IMAGE_CANDIDATES } from './codexImageCandidates.js';
...
export const CODEX_IMAGE_CAPABILITY = Object.freeze({
  models: ['provider-default', ...Object.keys(CODEX_IMAGE_CANDIDATES)], operations: ['generate', 'edit'], defaultModel: 'provider-default',
