...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.6.1-blue.svg?style=flat-square" alt="Version">
...
- `v0.6.1` / `v0.6.1-full`: specific Full version
- `v0.6.1-lite`: specific Lite version
