...
- `v0.5.2` / `v0.5.2-full` — Specific version (Full)
- `v0.5.2-lite` — Specific version (Lite)
...
| Windows   | AGNT-0.5.2-win-x64.exe             | AGNT-Lite-0.5.2-win-x64.exe        | ~4MB    |
| macOS     | AGNT-0.5.2-mac-{arch}.dmg          | AGNT-Lite-0.5.2-mac-{arch}.dmg     | ~4MB    |
