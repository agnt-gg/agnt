...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.5.7-blue.svg?style=flat-square" alt="Version">
...
- `v0.5.7` / `v0.5.7-full` — Specific version (Full)
- `v0.5.7-lite` — Specific version (Lite)
...
| Windows   | AGNT-0.5.7-win-x64.exe             | AGNT-Lite-0.5.7-win-x64.exe        | ~4MB    |
| macOS     | AGNT-0.5.7-mac-{arch}.dmg          | AGNT-Lite-0.5.7-mac-{arch}.dmg     | ~4MB    |
...
```bash
# Bug fix / hotfix (0.5.7 → 0.5.8)
npm run release:patch

# New feature (0.5.7 → 0.6.0)
npm run release:minor

# Breaking change (0.5.7 → 1.0.0)
