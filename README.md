...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.5.4-blue.svg?style=flat-square" alt="Version">
...
- `v0.5.4` / `v0.5.4-full` — Specific version (Full)
- `v0.5.4-lite` — Specific version (Lite)
...
| Windows   | AGNT-0.5.4-win-x64.exe             | AGNT-Lite-0.5.4-win-x64.exe        | ~4MB    |
| macOS     | AGNT-0.5.4-mac-{arch}.dmg          | AGNT-Lite-0.5.4-mac-{arch}.dmg     | ~4MB    |
